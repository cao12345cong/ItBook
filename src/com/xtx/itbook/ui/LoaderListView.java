...
public class LoaderListView extends ListView implements OnScrollListener {
	...
	// 监听接口以供加载更多数据.
	private LoadNotifyer mListViewListener;
	...
	private final static int PULL_LOAD_MORE_DELTA = 60; // when pull up >= 50px
														// at bottom, trigger
														// load more.
	...
	public void setLoadNotifyer(LoadNotifyer l) {
		mListViewListener = l;
	}
