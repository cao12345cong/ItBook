...
public class WechatPage extends SlidingMenuPage implements OnClickListener,
        PlatformActionListener
{
    ...
    public void onClick(View v)
    {
        ...
        ShareParams sp = ctvStWm.isChecked() ? getWechatMomentsShareParams(v)
                : getWechatShareParams(v);
        plat.share(sp);
    }
    ...
    private ShareParams getWechatShareParams(View v)
    {
        ...
        switch (v.getId())
        {
            ...
            {
                sp.shareType = Platform.SHARE_IMAGE;
                sp.imageData = BitmapFactory.decodeResource(v.getResources(),
    ...
    public boolean handleMessage(Message msg)
    {
        ...
        switch (msg.arg1)
        {
            ...
            { // 失败
                ...
                {
                    text = menu.getContext().getString(
