 ...
 * Original file: D:\\caocong\\ItBook_Android\\src\\com\\yyxu\\download\\services\\IDownloadService.aidl
 */
package com.yyxu.download.services;
public interface IDownloadService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.yyxu.download.services.IDownloadService
{
private static final java.lang.String DESCRIPTOR = "com.yyxu.download.services.IDownloadService";
...
/**
 * Cast an IBinder object into an com.yyxu.download.services.IDownloadService interface,
 * generating a proxy if needed.
 */
public static com.yyxu.download.services.IDownloadService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = (android.os.IInterface)obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.yyxu.download.services.IDownloadService))) {
return ((com.yyxu.download.services.IDownloadService)iin);
}
return new com.yyxu.download.services.IDownloadService.Stub.Proxy(obj);
}
...
private static class Proxy implements com.yyxu.download.services.IDownloadService
{
